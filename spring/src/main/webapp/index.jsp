...
<a href="/sysUserController/showJson" target="_blank">json测试页面</a> <br>
<a href="/sysUserController/showEasyUI" target="_blank">easyUI</a> <br>

<br>
<a href="/sysUserController/showLogin" target="_blank">显示登陆页面</a>
